...
---  
# Email  
This chapter contains email usage examples.  
## Introduction  
The email component provides common email sending operations. It supports sending pools in a multi-goroutine manner and also supports result callbacks.  
## Configuration  
